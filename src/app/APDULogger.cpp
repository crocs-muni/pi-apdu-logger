...
* g++ -o ./build/app/apduLogger ./src/app/Sampler.cpp ./src/app/Filter.cpp ./src/app/FileManager.cpp ./src/app/Decoder.cpp ./src/app/APDULogger.cpp -l wiringPi
* */
...
class Formatter 
{
	...
	{
		for (int i=5; i<fileContent.size(); i++) //skip atr + pts
		{ 
